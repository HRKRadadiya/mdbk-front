...
function ClientStep3({ onFinish, onPreviousBtn, stepComplete, formError }: IProps) {
    ...
    const [step3Form, setStep3Form] = useState<any>({
        desired_date: clientMember.desired_date,
        desired_time: clientMember.desired_time,
        desired_project_type: clientMember.desired_project_type,
        insurance_status: clientMember.insurance_status,
        desired_work_type: clientMember.desired_work_type,
    })
        ...
        <Form
            ...
            <div className="ft-h134 at-h60">
                <div className="mt-20">
                    <Form.Item name="desired_date" >
                        <Radio.Group name="desired_date" onChange={(e) => handleChangeForm(e, 1)} className="w-100 ft-db-select">
            ...
            <div className="ft-h134 at-h60">
                <div className="mt-20">
                    <Form.Item name="desired_time">
                        <Radio.Group name="desired_time" onChange={(e) => handleChangeForm(e, 2)} className="w-100 ft-db-select">
            ...
            <div className="ft-h170">
                <div className="mt-20">
                    <Form.Item name="desired_project_type">
                        <Radio.Group name="desired_project_type" onChange={(e) => handleChangeForm(e, 3)} className="w-100 ft-db-select ft-project-type">
            ...
            <div className="ft-h134 at-h60">
                <div className="mt-20">
                    <Form.Item name="insurance_status" >
                        <Radio.Group name="insurance_status" onChange={(e) => handleChangeForm(e, 4)} className="w-100 ft-db-select">
            ...
            <div className="mt-20">
                <Form.Item name="desired_work_type" >
                    <Radio.Group name="desired_work_type" onChange={(e) => handleChangeForm(e, 5)} className="w-100 ft-db-select">
