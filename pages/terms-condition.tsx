...
function TermsCondition() {
    ...
    return (
        <>
            <div className={`${styles.container} minhight tc-termscondition-page`}>
                <div className="tc-bg"></div>
                <LoginHeader headingtext={t('login.heading')} />
                <ToastContainer />
                <LoginHeaderMobile headingtext={t('login.heading')} />

                <div className="tc-content-outer">
                    <div className="termscondition-main-page">
                        <div className="tc-title">
                            <p>이용약관</p>
                        </div>
                        <div className="terms-scroll-content-bar">
                            <div className="tc-title-content tc-content-scroll">
